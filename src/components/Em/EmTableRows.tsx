...
const SaveGoals = () => {
  ...
  return (
    <div
      ...
      style={{ backgroundColor: '#FFFFFF', position: 'absolute', transform: 'translateY(-15px)',maxWidth: "450px", maxHeight: "400px"  }}
    >
      <div
        className="bg-#DCEDF6-300 w-full h-auto rounded-t-lg py-1 text-center"
        style={{ backgroundColor: '#38857B', color: 'white', fontSize: '26px', fontFamily: "CeraProBold", }}
      >
        Saving goals
      </div>
      <div className="grid grid-rows-2 w-auto grid-cols-2 h-full m-4 my-9 gap-3">
        <div className="bg-green-200 rounded-lg" style={{ backgroundColor: '#FEF9DE' }}>
          <h3 className="text-start ms-2 mt-4" style={{ color: '#25384D', fontSize: '22px' }}>
            First Home
          </h3>
          <p className="text-start ms-2 mt-1" style={{ color: '#25384D', fontSize: '16px' }}>
            Progress
          </p>
  ...
  return (
    <>
        ...
        <tbody className="gap-x-7 gap-y-7">
          <tr className="bg-white-600 custom_border" >
            <td className="flex px-4" style={{ alignItems: 'center' }}>
              <img src={`assets/icons/${props.img}`} className="mr-3" alt="" style={{ width: '40px' }} />
            ...
            <td className="custom_icons_grid">
              ...
              <Tippy content={<span>Remove Employee</span>} placement="bottom" animation="scale">
                ...
                >
                  <img src="assets/icons/close.svg" className="custom_icon" alt="" />
                </a>
              </Tippy>
            </td>
          </tr>
            ...
            <Box sx={style}>
              <div className="py-4">
                <div className="flex justify-between text-start">
                  ...
                  <img src="assets/icons/cross69.svg" onClick={handleClose} className="cursor-pointer" alt="" />
                </div>
            ...
            <Box sx={style2}>
              <div className="py-4">
                <div className="flex justify-end">
                  <img src="assets/icons/cross69.svg" onClick={handleClose2} className="cursor-pointer" alt="" />
                </div>
        ...
        <tbody className="gap-x-7 gap-y-7">
          <tr className="bg-white-600 custom_border">
            <td className="flex p-4 w-1/3">
              <img src={`assets/icons/${props.img}`} className="mr-3" alt="" />
            ...
            <td className="flex justify-start">
              <img src={`assets/icons/${props.catimg}`} alt="" />
      ...
      {shouldShowDashRows && (
        <tbody className="gap-x-7 gap-y-7">
          <tr className="bg-white-600 custom_border">
            <td className="flex px-4 py-3 w-1/3 items-center">
              <img src={`assets/icons/${props.img}`} className="mr-3" alt="" />
              <h5 className="text-start pt-1">{props.name}</h5>
            </td>
      ...
      {shouldShowDealsRows && (
        <tbody className="gap-x-7 gap-y-7 cursor-pointer">
          <tr
            className="bg-white-600  custom_border rounded transition-colors hover:bg-yellow-500 rounded "
            onClick={() => {
      ...
      {props.rkey === 'dealsCreatedByYou' && (
        <tbody className="gap-x-7 gap-y-7">
          <tr className="bg-white-600 custom_border items-center rounded mt-5  transition-colors hover:bg-yellow-500 ">
            <td className="flex p-4 ">
              <img src={`assets/icons/${props.img}`} className="mr-3" alt="" />
              <h5 className="text-start  cursor-pointer">{props.brand}</h5>
            </td>
            <td style={{ color: '#25384D' }} className=" text-md   text-start">
              {props.offerTitle}
            </td>
            ...
            <td className="custom_icons_grid items-end" style={{justifyContent:"flex-end"}}>
