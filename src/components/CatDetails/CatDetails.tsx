...
export default function CatDetails(_prop: any) {
  return (
    <div className="w-full ms-5 mb-10">
      <div className="text-start ms-4 mt-5">
        <div className="flex items-center" style={{ color: '#25384D' }}>
         <Link to="/Deals"><img src="assets/icons/arrow_left.svg" className="mr-4" alt="" /></Link> 
        ...
        <div className='mt-6 mb-10 text-start' style={{ color: "#25384D", fontWeight: "400", fontSize: "16px", lineHeight: "24px" }}>
