  ...
  return (
    <div className="w-full h-min-screen pr-10 pl-10">
      ...
      <div className="mt-5 flex justify-between" id="di">
        <div className="custom_employee_tabs">
        ...
        <div>
          <ul className="flex ">
            <li className="list-none p-2 rounded-lg flex items-center  cursor-pointer" onClick={sendANotOp}>
              <img src="icons/bell.svg" className="mr-2" alt="" />
              <h6>{SendANotification}</h6>
            </li>
            <li className="list-none mx-2 border-2 border-solid rounded-lg flex cursor-pointer items-center" style={{borderColor: "#34897b"}} onClick={giftAllEmOp}>
              <img src="icons/gift.svg" className="ms-1" width={'20px'} alt="" />
              <h6 className="  ms-2 me-2">{GiftAllEmployees}</h6>
            </li>
