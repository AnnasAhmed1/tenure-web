      ...
      <div className="flex">
        ...
        >
          <div className="rounded-lg p-4">
            <div className="flex justify-between items-start">
              <div className="flex">
                <img src={`assets/icons/wallet_1.svg`} className="mr-2" alt="" />
                <h1>Wallet</h1>
              </div>
              <div className="flex cursor-pointer">
                <img src="assets/icons/edit.svg" className="mr-2" alt="" />
                ...
                >
                  <Box sx={style2}>
                    <div className="flex justify-end">
                      <img src="assets/icons/cross69.svg" className="cursor-pointer" onClick={sendANotCl} alt="" />
                    </div>
            ...
            <div className="flex justify-center pt-40">
              ...
              >
                <img src="assets/icons/add_2.svg" className="mr-2" alt="" />
                Top up Wallet
              </button>
            </div>
          </div>
        ...
        >
          <div className="rounded-lg p-4">
            <div className="flex justify-between items-start">
              <div className="flex">
                <img src={`assets/icons/cards_2.svg`} className="mr-2 w-10" alt="" />
                <h1>Link cards</h1>
              </div>
              <div className="flex cursor-pointer" onClick={() => navigate('/AddCard')}>
                <img src="assets/icons/add_1.svg" className="mr-2" alt="" />
          ...
          <div className="flex flex-col mt-5">
            <div className="flex justify-between border mx-3 rounded-lg p-2 my-3">
              <div className="flex">
                <img src="assets/icons/mastercard.svg" className="mr-3 w-10" alt="" />
            ...
            <div className="flex justify-between border mx-3 rounded-lg p-2 my-3">
              <div className="flex">
                <img src="assets/icons/visa.svg" className="mr-3 w-10" alt="" />
                <div className="flex flex-col">
                  <h5 className="text-lg font-bold text-start">1234****1280</h5>
                  <p className="text-start">Expires 6/24</p>
                </div>
