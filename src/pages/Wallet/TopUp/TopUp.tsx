...
const [activeBank, setactiveBank] = useState("");
  ...
  return (
    ...
    <div className='flex text-start ms-4 mt-5'>
      <img src="assets/icons/arrow_left.svg" onClick={()=>navigate('/wallet')} className='mr-4 cursor-pointer' alt="" />
      {/* <h1>{location.pathname==='/Edit'&&'Edit Card Details'}</h1> */}
      <h1>Top Up Wallet</h1>
    </div>

    <div className='w-full ms-5 mt-5'>
        <div className='flex gap-3'>
        <div className={`rounded-xl cursor-pointer  border-2 pl-2 py-2 ${active==='card' && 'border-primary-400'}`} style={{width:'110px',}} onClick={()=>setActive('card')}>
            <img src={`assets/icons/${active==='card'?'wallet_1.svg':'wallet_1.svg'}`} alt="" />
            <p className='text-start text-gray mt-3'>Card</p>
        </div>
        <div className={`rounded-xl cursor-pointer border-2 pl-2 py-2 ${active === 'bank' && 'border-primary-400'}`} style={{width:'110px',}} onClick={()=>setActive('bank')}>
            <img src={`assets/icons/${active==='bank'?'bank_2.svg':'bank_1.svg'}  `} alt="" />
...
{  active==='card' && 
     ...
     <form className='flex flex-col mt-2' style={{width:"95%"}}onSubmit={formik.handleSubmit}>
        <TextField 
...

{
    ...
    <form className='flex flex-col mt-9' style={{ width: "95%" }} onSubmit={formik2.handleSubmit}>
           ...
           <div className={`border-4 w-3/12 rounded-lg flex items-center justify-center  ${activeBank === "Canada" ? " bg-green-200 " :" "} `}><img src={`assets/images/bankofcanada.png`} alt="" className=' m-auto ' style={{width:"50%"}}/>   </div>
                        
           <div className={`border-4 w-3/12 rounded-lg flex items-center justify-center ${activeBank === "TD" ? " bg-green-200 " :" "} `}><img src={`assets/images/td.png`} alt="" className=' m-auto ' style={{width:"50%"}}/>   </div>
           <div className={`border-4 w-3/12 rounded-lg flex items-center justify-center ${activeBank === "Royal" ? " bg-green-200 " :" "} `}><img src={`assets/images/rbc.png`} alt="" className=' m-auto ' style={{width:"50%"}}/>   </div>
           <div className={`border-4 w-3/12 rounded-lg flex items-center justify-center ${activeBank === "Nova" ? " bg-green-200 " :" "} `}><img src={`assets/images/scoti.png`} alt="" className=' m-auto ' style={{width:"50%"}}/>   </div>
           <div className={`border-4 w-3/12 rounded-lg flex items-center justify-center ${activeBank === "Montreal" ? " bg-green-200 " :" "} `}><img src={`assets/images/m.png`} alt="" className=' m-auto ' style={{width:"50%"}}/>   </div>
