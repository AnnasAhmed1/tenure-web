    ...
    <div className="flex h-min-screen">
      <div className="w-full ms-5">
        <div className="flex mt-6" id="prDiv">
          <a
            className={`mx-2 cursor-pointer text-xl ${selectedCategory2 === 'Employee Deals' ? 'blink' : ''}`}
            onClick={EmDeals}
          >
            {Employeedeals}
          </a>
          <a
            className={`mx-2 cursor-pointer text-xl ${selectedCategory2 === 'Employer Deals' ? 'blink' : ''}`}
            onClick={EmrDeals}
          >
            {Employerdeals}
          </a>
          <a
            className={`mx-2 cursor-pointer text-xl ${selectedCategory2 === 'Customer Deals' ? 'blink' : ''}`}
            onClick={CusDeals}
          >
            {Createdbyyou}
          </a>
